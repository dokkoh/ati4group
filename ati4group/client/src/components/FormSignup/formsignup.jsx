        ...
        <div className="bg-background-grey pb-10">
            <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:px-8">
                ...
                <div className="mx-auto max-w-3xl">
                    <div id='success' style={{ display: 'none', textAlign: 'center', padding: '2rem' }}>Votre message a été envoyé avec succes
                        <img src="https://static9.depositphotos.com/1674252/1149/v/600/depositphotos_11495948-stock-illustration-green-positive-checkmark.jpg" alt="check verte pour signaler que le formulaire a bien été" />
                    </div>
                            ...
                            <div
                                ...
                                <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                    ...
                                    <div className="mt-2 sm:col-span-2 sm:mt-0">
                                        ...
                                        />
                                        {errors.message && <p className="text-red-600" role='alert'> Un message est obligatoire </p>}
                                    </div>
                                </div>
                            </div>
