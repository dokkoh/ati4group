            ...
            <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-background-grey px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                    <p className="text-sm leading-6 text-gray-900">
                        <strong className="font-semibold">Inscrivez-vous vite à l&#39;évènement, il ne reste que <Counter /> places !</strong>
                    </p>
                    <a
                        href="#"
                            ...
                            <div className="w-full flex-auto">
                                ...
                                <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                                    <div className="mt-2 flex items-center text-sm text-primary-gray">
                                        <MapPinIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-primary-orange" aria-hidden="true" />
                                        Strasbourg, France
                                    </div>
                                    <div className="mt-2 flex items-center text-sm text-primary-gray">
                                        <CalendarIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-primary-orange" aria-hidden="true" />
                                        01 Septembre 2023
                                    </div>
                                </div>
